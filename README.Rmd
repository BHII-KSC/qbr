...
The qb_run function makes it easy to extract report data via the Quickbase JSON API:
...
This package makes no attempt to convert datatypes. Number fields in Quickbase
may well be interpreted in the resulting tibble as characters. The qb_run function
